...
static func get_coords(source_coord: Vector2i, target_coord: Vector2i, is_obstacle: Callable, is_obstacle_args: Array) -> Array:
...
static func trim_coords(coords: Array, trim_head: bool, trim_tail: bool) -> Array:
